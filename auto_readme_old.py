...
class AutoReadme:
    ...
    def test_run(self, project_information: dict):
        ...
        messages = [
            {"role": "system", "content": f"{self.start_prompt}"}
        ]
        return self.use_chatgpt(self.start_prompt)

    def chat_generate_

    def use_chatgpt(self, messages,open_ai_key=None):
...
if __name__ == '__main__':
    ...
    print(generate.test_run(project))